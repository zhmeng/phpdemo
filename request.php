...
Class Request{
    ...
    public function submitOrderInfo(){
        ...
        $this->reqHandler->setParameter('trade_type','trade.weixin.native');//接口类型：pay.weixin.scancode
            ...
            if($this->resHandler->isTenpaySign()){
                ...
                if($this->resHandler->getParameter('return_code') == 'SUCCESS' 
                    ...
                    echo json_encode(array('code_img_url'=>$this->resHandler->getParameter('code_img_url'),
                                           ...
                                           'out_trade_no'=>$this->reqHandler->getParameter('out_trade_no')));
                    exit();
                }else{
...
//        $res = Utils::parseXML($xml);
        ...
        if($this->resHandler->isTenpaySign()){
            if($this->resHandler->getParameter('return_code') == 'SUCCESS' 
                && $this->resHandler->getParameter('result_code') == 'SUCCESS'){
                sysdebug($this->resHandler->getAllParameters());
